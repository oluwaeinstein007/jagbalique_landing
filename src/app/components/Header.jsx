      ...
      <header className="bg-white border-b border-gray-200 sticky top-0 z-50">
        <div className="bg-white px-6 py-4">
          <div className="max-w-7xl mx-auto flex justify-between items-center">
            <div className="text-2xl font-bold text-blue-900">JAGBALIQUE</div>
            <button 
              className="lg:hidden"
        ...
        <nav className={`bg-blue-700 ${mobileMenuOpen ? 'block' : 'hidden'} lg:block`}>
          <div className="max-w-7xl mx-auto px-6">
            <ul className="flex flex-col lg:flex-row lg:space-x-1 text-white text-sm">
              {['Home', 'About Us', 'Our Services', 'Sectors We Serve', 'OEM Partners', 'Projects / Footprint', 'Contact Us', 'News / Updates'].map((item) => (
                <li key={item}>
